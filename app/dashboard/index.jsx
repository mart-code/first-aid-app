...
const markerImages = {
  health: require('../assets/health-marker.png'),
  fire: require('../assets/fire-marker.png'),
  safety: require('../assets/safety-marker.png'),
  user: require('../assets/user-marker.png')
};
  ...
  const renderMarkers = () => {
    return (
      <>
        ...
        {location && (
          <MapboxGL.MarkerView coordinate={location} anchor={{ x: 0.5, y: 0.5 }}>
            <Image source={markerImages.user} style={{ width: 32, height: 32 }} />
          </MapboxGL.MarkerView>
        )}
        ...
        {locations.healthCenters.map(center => (
          <MapboxGL.MarkerView
            ...
            anchor={{ x: 0.5, y: 0.5 }}
          >
            <Image source={markerImages.health} style={{ width: 28, height: 28 }} />
          </MapboxGL.MarkerView>
        ))}
        ...
        {locations.fireStations.map(station => (
          <MapboxGL.MarkerView
            ...
            anchor={{ x: 0.5, y: 0.5 }}
          >
            <Image source={markerImages.fire} style={{ width: 28, height: 28 }} />
          </MapboxGL.MarkerView>
        ))}
        ...
        {locations.roadSafety.map(safety => (
          <MapboxGL.MarkerView
            ...
            anchor={{ x: 0.5, y: 0.5 }}
          >
            <Image source={markerImages.safety} style={{ width: 28, height: 28 }} />
          </MapboxGL.MarkerView>
        ))}
      </>
    );
